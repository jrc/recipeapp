...
function testAnnotateDurations() {
  ...
  console.assert(
    result ===
      'Cook for about <span class="duration" title="SEC=300" data-value="duration:SEC=300">⏲️ 5 minutes</span>.',
  ...
  console.assert(
    result ===
      'The meeting will last for <span class="duration" title="SEC=7200" data-value="duration:SEC=7200">⏲️ 2 hours</span>.',
  ...
  console.assert(
    result ===
      'Wait for <span class="duration" title="SEC=30" data-value="duration:SEC=30">⏲️ 30 seconds</span>.',
  ...
  console.assert(
    result ===
      'Cook for <span class="duration" title="SEC=60" data-value="duration:SEC=60">⏲️ 1 minute</span>.',
  ...
  console.assert(
    result ===
      'Wait <span class="duration" title="SEC=3600" data-value="duration:SEC=3600">⏲️ 1 hour</span>.',
  ...
  console.assert(
    result ===
      'Pause for <span class="duration" title="SEC=1" data-value="duration:SEC=1">⏲️ 1 second</span>.',
  ...
  console.assert(
    result ===
      'Exercise for <span class="duration" title="SEC=3600" data-value="duration:SEC=3600">⏲️ 1 hour</span> and <span class="duration" title="SEC=1800" data-value="duration:SEC=1800">⏲️ 30 minutes</span>.',
  ...
  console.assert(
    result ===
      'Cover tightly with foil and bake for <span class="duration" title="SEC=2100" data-value="duration:SEC=2100">⏲️ 35-40 minutes</span>.',
  ...
  console.assert(
    result ===
      'continue to boil for <span class="duration" title="SEC=180" data-value="duration:SEC=180">⏲️ 3 - 4 minutes</span>.',
  ...
  console.assert(
    result ===
      'Keep turning as the liquid reduces to a shiny glaze, <span class="duration" title="SEC=600" data-value="duration:SEC=600">⏲️ 10 to 12 minutes</span>.',
  ...
  console.assert(
    result ===
      'about <span class="duration" title="SEC=90" data-value="duration:SEC=90">⏲️ 1.5 minutes</span>.',
  ...
  console.assert(
    result ===
      'Cook for <span class="duration" title="SEC=300" data-value="duration:SEC=300">⏲️ 5 min</span>.',
  ...
  console.assert(
    result ===
      'Wait <span class="duration" title="SEC=30" data-value="duration:SEC=30">⏲️ 30 sec</span>.',
  ...
  console.assert(
    result ===
      'Meet for <span class="duration" title="SEC=7200" data-value="duration:SEC=7200">⏲️ 2 hrs</span>.',
  ...
  console.assert(
    result ===
      'Cook for <span class="duration" title="SEC=300" data-value="duration:SEC=300">⏲️ 5-10 minutes</span>, then rest for <span class="duration" title="SEC=900" data-value="duration:SEC=900">⏲️ 15 to 20 minutes</span>.',
  ...
  console.assert(
    result ===
      '<span class="duration" title="SEC=300" data-value="duration:SEC=300">⏲️ 5 Minutes</span> and <span class="duration" title="SEC=30" data-value="duration:SEC=30">⏲️ 30 SECONDS</span>',
  ...
  console.assert(
    result ===
      'Ferment for <span class="duration" title="SEC=259200" data-value="duration:SEC=259200">⏲️ 72 hours</span>',
  ...
  console.assert(
    result ===
      '<span class="duration" title="SEC=0" data-value="duration:SEC=0">⏲️ 0 minutes</span>',
